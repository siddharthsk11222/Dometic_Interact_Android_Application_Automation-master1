package com.dometic.L2.qa.util;
...
public class ExtentReportUtil extends Baseclass {
    ...
    public void ExtentReport() throws UnknownHostException {
        ...
        htmlReporter.loadXMLConfig(System.getProperty("user.dir") + "/src/test/resources_L2/extent-config.xml");
        extent.attachReporter(htmlReporter);
        extent.setSystemInfo("Device Name", "Pixel4");
        extent.setSystemInfo("Platform Name", "Android");
        extent.setSystemInfo("Platform Version", "10");
    ...
    public void ExtentReportScreenshot() throws Throwable
    {
        ...
        File screenFile = new File(System.getProperty("user.dir") + "/target/cucumber-reports/advanced-reports/extentreportsL2/" + screenshot.getName());
