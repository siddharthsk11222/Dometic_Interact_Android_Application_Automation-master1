...
//    public Baseclass base=new Baseclass();
    ...
    public Properties loadProperties() throws IOException {
        prop = new Properties();
        FileInputStream fis = new FileInputStream(System.getProperty("user.dir") + "/src/test/resources_L1/globalData.properties");
        prop.load(fis);
        return prop;
    }
...
//        String app = prop.getProperty("app");
        cap.setCapability("app", System.getProperty("user.dir") + "/src/test/java/com/dometic/L1/application/app-release_188.apk");
