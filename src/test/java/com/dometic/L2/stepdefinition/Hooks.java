...
public class Hooks extends Baseclass {
    ...
    public Properties loadProperties() throws IOException {
        prop = new Properties();
        FileInputStream fis = new FileInputStream(System.getProperty("user.dir") + "/src/test/resources_L2/globalData.properties");
        prop.load(fis);
        return prop;
    }
...
//        System.out.print(PortNumber);
        ...
        cap.setCapability("app", System.getProperty("user.dir") + "/src/test/java/com/dometic/L2/application/Interact_v1.6_179.apk");
