...
public class Constant_forgotpassword extends Baseclass{
    ...
    public static final String Forgot_password_send = "//android.widget.TextView[contains(@text,'Send') or @content-desc='com.dometicapp:id/forgot-sendPasswordText']";
    ...
    public static final String ForgetPassword_page_title_access_id="//android.widget.TextView[contains(@text,'Forgot your password?') or @content-desc='com.dometicapp:id/forgot-forgotPwdText']";
    ...
    public static final String ForgetPassword_forgot_enterEmail_access_id="//android.widget.TextView[contains(@text,'Don´t worry. Resetting your password is very easy.') or @content-desc='com.dometicapp:id/forgot-enterEmail']";
    ...
    public static final String ForgetPassword_forgot_createPass_access_id="//android.widget.TextView[contains(@text,'Please insert below the email address you registered your') or @content-desc='com.dometicapp:id/forgot-createPass']";
    ...
    public static final String ForgetPassword_forgot_emailReceive_access_id="//android.widget.TextView[contains(@text,'account with. Soon you will receive an email to reset your') or @content-desc='com.dometicapp:id/forgot-emailReceive']";
    ...
    public static final String ForgetPassword_forgot_checkSpam_access_id="//android.widget.TextView[contains(@text,'password. Please remember to check your spam or junk') or @content-desc='com.dometicapp:id/forgot-checkSpam']";
    public static final String ForgetPassword_forgot_checkSpam_expected="password. Please remember to check your spam or junk";
    public static final String ForgetPassword_forgot_checkInbox_access_id="//android.widget.TextView[contains(@text,'folder if you can’t see the email in your inbox within the') or @content-desc='com.dometicapp:id/forgot-checkInbox']";
    ...
    public static final String ForgetPassword_forgot_checkinMin_access_id="//android.widget.TextView[contains(@text,'next 15 minutes.') or @content-desc='com.dometicapp:id/forgot-checkinMin']";
    public static final String ForgetPassword_forgot_checkinMin_expected="next 15 minutes.";
    public static final String ForgetPassword_forgot_email_label_access_id="//android.widget.TextView[contains(@text,'E-mail') or @content-desc='com.dometicapp:id/forgot-email']";
